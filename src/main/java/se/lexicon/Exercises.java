...
public class Exercises {
    ...
    */
    ...
    public static void exercise5(String message){
        System.out.println(message);
        System.out.println(storage.findOneAndMapToString(person -> person.getId() == (456), person -> "Name: " + person.getFirstName() + " " + person.getLastName() + " born " + person.getBirthDate()));
    ...
    public static void exercise6(String message){
        System.out.println(message);
        System.out.println(storage.findManyAndMapEachToString(person -> person.getFirstName().startsWith("E"), Person::toString));
    ...
    public static void exercise7(String message){
        System.out.println(message);
        System.out.println(storage.findManyAndMapEachToString(person -> Period.between(person.getBirthDate(), LocalDate.now()).getYears() < 10, person -> person.getFirstName() + " " + person.getLastName() + " " + Period.between(person.getBirthDate(), LocalDate.now()).getYears() + " years"));
    ...
    public static void exercise10(String message){
        System.out.println(message);
        storage.findAndDo(person -> person.getFirstName().equalsIgnoreCase(new StringBuilder().append(person.getFirstName()).reverse().toString().trim()), System.out::println);
    ...
    public static void exercise12(String message){
        System.out.println(message);
        System.out.println(storage.findAndSort(person -> person.getBirthDate().isBefore(LocalDate.parse("1950-01-01")), Comparator.comparing(Person::getBirthDate).reversed()));
    ...
    public static void exercise13(String message){
        System.out.println(message);
        System.out.println(storage.findAndSort(Comparator.comparing(Person::getLastName).thenComparing(Person::getFirstName).thenComparing(Person::getBirthDate)));
